...
main_shape = gp.read_file("data/edited/CSB/CSB1623_dises_supplemented_1.geojson")
...
main_shape.to_file("data/edited/CSB/CSB1623_dises_supplemented_2.geojson", driver="GeoJSON")
attribute_table = main_shape.drop(columns='geometry')
attribute_table.to_csv("data/edited/CSB/CSB1623_dises_supplemented_2_table.csv", index=False)

#---# Save nearest points table
nearest_points_df = pd.DataFrame(nearest_points_data)
nearest_points_df.to_csv("data/edited/CSB/CSB1623_points_on_road_table.csv", index=False)
...
try: 
    ...
    point_on_road_gdf.to_file("data/edited/CSB/CSB1623_points_on_road.geojson")
