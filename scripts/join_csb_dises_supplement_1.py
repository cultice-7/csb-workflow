...
# Load main dataset
main_shape = gp.read_file("data/edited/CSB/CSB1623_dises_spatialjoin.geojson")
...
main_shape.to_file("data/edited/CSB/CSB1623_dises_supplemented_1.geojson", driver="GeoJSON")
attribute_table = main_shape.drop(columns='geometry')
attribute_table.to_csv("data/edited/CSB/CSB1623_dises_supplemented_1_table.csv", index=False)
