...
def combine_clean_regrow_files(regrow_input_folder, state):
    ...
    regrow_supplement_1_table_input_path = os.path.join(regrow_input_folder, f"{state}_regrow_census_tract_table.parquet")
...
def merge_all_crop_prices_by_state(state, regrow_output_folder, temp_dir):
    ...
    output_path = os.path.join(regrow_output_folder, f"{state}_regrow_crop_prices_table.parquet")
