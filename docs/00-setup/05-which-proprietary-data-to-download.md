...
- **USDA Ag Census** — create `data/USDA Ag Census/` folder. Place 4 per-state CSV exports from USDA NASS QuickStats directly in this folder: `{state}_Census_Economics_Farm Operations_Farm Ownership_Conservation Practices_2017&2022.csv`, `{state}_Census_Crops_Field Crops_2017&2022.csv`, `{state}_Census_Demographics_Farms_Land Ownership_Assets_2017&2022.csv`, and `{state}_Census_Demographics_Producer Characteristics_2017&2022.csv`.
